#AI-Powered Clinical & IoT Companion 🩺

> **"رفيقك الذكي، دائمًا بجانبك ورعايتك."**

**AI-Powered Clinical & IoT Companion** هو نظام برمجيات متكامل يمثل **مساعدًا سريريًا شخصيًا ذكيًا** للمرضى الذين يعانون من أمراض مزمنة (مثل السكري، ضغط الدم، واضطرابات الغدد الصماء). لا يهدف النظام إلى استبدال الطبيب، بل يملأ الفجوة الكبيرة بين الزيارات السريرية من خلال تقديم إرشادات طبية فورية، وإدارة ذكية ومؤتمتة للأدوية، ومراقبة صحية استباقية على مدار الساعة عبر دمج الذكاء الاصطناعي مع **علبة الدواء الذكية (IoT Smart Pillbox)**.
